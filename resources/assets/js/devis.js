$( document ).ready(function() {
    ...
    $(document).on("click","input[type='image']", function(e){
        ...
        if ($(this).attr('class').indexOf("plus") >= 0){
            ...
            '<td><input class = plus id='+ligne+' onclick="return false;" type=image src=http://cdmpeinture.dev/images/plus.png width=24 height=24>'+
            '<input class = minus id='+ligne+' onclick="return false;" type=image src=http://cdmpeinture.dev/images/minus.png width=24 height=24/></td>'+

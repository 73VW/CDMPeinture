...
class ttfparser
{
    ...
    public function ParseOffsetTable()
    {
        $version = $this->Read(4);
        if ($version == 'OTTO') {
    ...
    public function SetTable($tag, $data)
    {
        $length = strlen($data);
        $n = $length % 4;
        if ($n > 0) {
